        ...
        <>
            ...
            <div className="video-container">
                ...
                <video autoPlay loop muted className="video-background" playsInline>
                    <source src="/assets/video/ptu.mp4" type="video/mp4" />
                </video>
                <div className="video-overlay">
                    <div className="overlay-content">
                        <h1 className="main-title">INTERNAL QUALITY ASSURANCE CELL (IQAC) - PTU</h1>
                    </div>
                </div>
            </div><div className="news"> <NewsUpdates/></div>
            <CardSlider/>
